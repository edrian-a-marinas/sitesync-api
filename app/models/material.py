from sqlalchemy import Computed, ForeignKey, Integer, Numeric, String
...
class Material(Base):
    ...
    total_cost: Mapped[float] = mapped_column(Numeric(12, 2), Computed("quantity * unit_cost"), nullable=False)
